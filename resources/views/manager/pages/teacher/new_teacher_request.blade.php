...
@section('content')
    <div class="page-heading">
        <h1 class="page-title">New Teacher Request (Total: {{ number_format($total) }}) &nbsp; <a
                href="{{ url('manager/new_teacher_request_approve_all') }}"
                onclick="return confirm('Are you sure to approve all?');" type="button" class="btn btn-primary px-4">Approve
                All</a></h1>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/manager/rejected_teacher_list') }}">Rejected</a></li>
        </ol>
    </div>
        ...
        <div class="row">
            @foreach ($teacherProfile as $teacher)
                <div class="col-md-4 mb-3">
                    <a href="{{ url('manager/teacher_details') }}{{ $teacher->id }}" class="card">
