...
@section('title', 'Search Result | manager')
...
@section('content')
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/manager/dashboard') }}"><i class="icon-home2 position-left"></i>
                    Home</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/new_teacher_request') }}">New Teacher</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/home_approval_teacher') }}">Home Approval Teacher</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/approval_teacher_list') }}">Approval Teacher</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/rejected_teacher_list') }}">Rejected Teacher</a></li>
        </ol>
    </div>

    <form action="{{ url('manager/send_bulk_text') }}" method="post">
        @csrf
                        ...
                        @if ($profile->user)
                            <div class="card teacher_list">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{{ url('/manager/teacher_details') }}{{ $profile->user ? $profile->user->id : '' }}"
