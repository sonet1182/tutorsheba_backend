...
@section('title', 'Teacher Details | manager')
...
@section('content')
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/manager/new_teacher_request') }}">New Teacher Request</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/approval_teacher_list') }}">Approval Teacher List</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/rejected_teacher_list') }}">Rejected Teacher List</a></li>
        </ol>
    </div>
    ...
    <div class="page-content my-5">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-center my-5">
                                ...
                                <a href="{{ url('manager/teacher_rejected') }}{{ $teacherDetails->id }}"
                                    class="btn btn-lg btn-warning">Rejected</a>
                                <a href="{{ url('manager/teacher_approval') }}{{ $teacherDetails->user_id }}"
                                    class="btn btn-lg btn-primary">Approve</a>
                                <a href="{{ url('manager/teacher_verify') }}{{ $teacherDetails->user_id }}"
                                    class="btn btn-lg btn-info"><i class="fa fa-star font-14"></i> Verify</a>
                                <a href="{{ url('manager/teacher_premium') }}{{ $teacherDetails->user_id }}"
                                    class="btn btn-lg btn-danger">Premium Membership</a>
                                <a href="{{ url('manager/balance/create') }}/{{ $teacherDetails->id }}"
                                    class="btn btn-lg btn-success">Add Balance</a>
                                <button type="button"
                                    data-href="{{ url('/manager/tutor-list/delete/'.$teacherDetails->user_id) }}"
        ...
        <div class="row mt-3">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/manager/apply_tuition_list/' . $teacherDetails->user_id) }}"
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/manager/assigned_tuition_list/' . $teacherDetails->user_id) }}"
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/manager/confirmed_tuition_list/' . $teacherDetails->user_id) }}"
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/manager/cancelled_tuition_list/' . $teacherDetails->user_id) }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <form action="{{ url('manager/send_text') }}" method="post">
                            @csrf
