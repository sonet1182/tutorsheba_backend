                    ...
                    <div class="card-body row">
                        <div class="col-md-6 ">
                                ...
                                <form action="{{ url('manager/payment/tuition_search_by_id') }}" method="POST" class="row">
                                    @csrf
                                    <b class="col-4">Search By Student Id:</b>
                        ...
                        <div class="col-md-6">
                            <form action="{{ url('manager/payment/tuition_search_by_phone') }}" method="POST" class="row">
                                    @csrf
                                    <b class="col-4">Search By Teacher Id:</b>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 80px">
                                            <a href="{{ url('manager/payment_details/'.$con->student_id) }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-edit font-14"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
