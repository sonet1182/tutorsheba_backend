    ...
    <div class="content-wrapper">
        ...
        <div class="page-header">
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    <li><a href="{{ url('/manager/dashboard') }}"><i class="icon-home2 position-left"></i> Home</a></li>
                    <li><a href="{{ url('/manager/new_student_request') }}">New student Request</a></li>
                    <li><a href="{{ url('/manager/approval_student_list') }}">Approval student List</a></li>
                    <li><a href="{{ url('/manager/rejected_student_list') }}">Rejected student List</a></li>
                </ul>
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        {!! Form::open(['url' => 'manager/tuition_request','method'=>'POST', 'class'=>'row form-horizontal','id'=>"contact_form"]) !!}
