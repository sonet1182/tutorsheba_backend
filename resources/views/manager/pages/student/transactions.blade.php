    ...
    <div class="page-content fade-in-up">
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row" action="{{ url('manager/transactions/search') }}" method="POST" class="row">
                            @csrf
                            <div class="col-md-5">
                                <b>From:</b>
                                ...
                                <select class="form-control col-12" name="manager">
                                    <option value="0">All</option>
                                        @foreach($manager_list as $managert)
                                            ...
                                            <option value="{{ $managert->id }}" {{ $manager == $managert->id ? 'selected' : '' }} >{{ $managert->name }}</option>
                                        @endforeach
                                </select>
                            </div> --}}
                            <div class="col-md-2">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('manager/payment_details/'.$txn->transaction->student->id) }}">
                                        ...
                                        <td>{{ $txn->transaction->student->manager_info ? $txn->transaction->student->manager_info->name : '' }}</td>
                                        <td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action="{{ url('manager/transactions/edit/' . $txn->id) }}"
                                                            method="post">
                                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <hr>
                                                                <b>Payment:</b>
                                                                <input type="number" name="payment" class="form-control my-2"
                                                                    placeholder="" value="{{ $txn->payment }}">
                                                                <b>Remark:</b>
