...
@section('content')
    ...
    <div class="page-heading">
        <h1 class="page-title">Search Result Tuition</h1>
        <ol class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body row">
                        <div class="col-md-6 ">
                                ...
                                <form action="{{ url('manager/tuition_search_by_id') }}" class="row">
                                    @csrf
                                    <input type="text" class="form-control col-8" name="job_id" placeholder="ID..."/>
                                    <button class="btn btn-primary col-4" type="submit">Search By Id</button>
                                </form>


                        </div>
                        <div class="col-md-6">
                            <form action="{{ url('manager/tuition_search_phone') }}" class="row">
                                    @csrf
                                    <input type="text" class="form-control col-8" name="phone" placeholder="Phone...."/>
                                    <button class="btn btn-primary col-4" type="submit">Search By Phone</button>
                                </form>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($studentProfile as $student)
                                    <tr>
                                        ...
                                        <td style="width: 80px">
                                            <a href="{{ url('manager/student_details') }}{{ $student->id }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-info-circle font-14"></i></a>
                                            <a type="button" data-toggle="modal" data-target="#editModalAssign{{ $student->id }}" data-toggle="tooltip" data-original-title="Keep Note" title="Keep Note" class="btn btn-default btn-xs"><i class="fa fa-edit font-14"></i></a>


                                                                <div class="modal fade" id="editModalAssign{{ $student->id }}" tabindex="-1" role="dialog"
