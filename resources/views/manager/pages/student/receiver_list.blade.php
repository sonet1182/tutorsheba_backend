...
@section('content')
    ...
    <div class="page-heading">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/maneger/dashboard') }}"><i class="icon-home2 position-left"></i> Home</a></li>
                    ...
                    <div class="ibox-body table-responsive">
                        <table class="table table-bordered" id="dataTable2">
                            ...
                            onerror="this.onerror=null;this.src='https://cdn4.iconfinder.com/data/icons/instagram-ui-twotone/48/Paul-18-512.png';"/>
                                    ...
                                    <td>
                                        <a href="{{ url('/manager/teacher_details'.$value->user_id) }}" title="View" class="btn btn-info btn-xs px-2"><i class="fa fa-eye" aria-hidden="true"></i></a>
