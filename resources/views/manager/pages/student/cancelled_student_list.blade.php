...
@section('content')
    ...
    <div class="page-heading">
        <h1 class="page-title">Cancelled Tuition</h1>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/manager/approval_student_list') }}">Approved</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/rejected_student_list') }}">Rejected</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/pending_student_list') }}">Pending</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body row">
                        ...
                        <!--                <option value="{{ url('manager/approval_student_list') }}">All</option>-->
                        <!--                @foreach($manager_list as $managert)-->

                        <!--                    <option value="{{ url('manager/approval_student_list/by_manager/'.$managert->id) }}" {{ $manager == $managert->id ? 'selected' : '' }} >{{ $managert->name }}</option>-->
                        <!--                @endforeach-->
                        <!--            </select>-->
                        <!--</div>-->
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($studentProfile as $student)
                                    <tr>
                                        ...
                                        <td style="width: 80px">
                                            <a href="{{ url('manager/student_details') }}{{ $student->id }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-edit font-14"></i></a>
