...
@section('content')
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/manager/new_student_requestr') }}">New Student Request</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/approval_student_list') }}">Approval Student List</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/manager/rejected_situdent_list') }}">Rejected student List</a>
            </li>
        </ol>
    </div>
                            ...
                            <tbody>
                                ...
                                @if (!empty($partner))
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('manager/uddokta_details/' . $partner->id) }}">
                                                <h6>{{ $partner->name }}</h6>
                                            </a>
                                        </td>
                                    </tr>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="mt-5 pb-3">
                            <div class="text-center">
                                <a href="{{ url('/manager/tuition/edit/') }}/{{ $studentDetails->id }}"
                                    class="btn btn-lg btn-info">Edit</a>
                                <a href="{{ url('manager/student_rejected') }}{{ $studentDetails->id }}"
                                    class="btn btn-lg btn-danger">Rejected</a>
                                @if ($studentDetails->approval == 1)
                                    <button class="btn btn-lg btn-success" disabled>Approved</button>
                                @else
                                    <a href="{{ url('manager/student_approval') }}{{ $studentDetails->id }}"
                                        class="btn btn-lg btn-success">Approved</a>
                                @endif

                                <a href="{{ url('manager/set_student_pending/' . $studentDetails->id) }}"
                                    class="btn btn-lg btn-warning">Set Pending</a>
                                <a href="{{ url('manager/set_student_cancel/' . $studentDetails->id) }}"
                            ...
                            <div class="card mb-3">
                                <div class="row">
                                    <div class="col-md-2 col-sm-5 col-xs-12 text-center">
                                        <a href="{{ url('/manager/teacher_details') }}{{ $confirmed->teacher->id }}">
                        ...
                        @elseif($assigned_list->count() > 0)
                            ...
                            @foreach ($assigned_list as $assigned)
                                <div class="card mb-3">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-5 col-xs-12 text-center">
                                            <a href="{{ url('/manager/teacher_details') }}{{ $assigned->teacher->id }}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ url('manager/assigned_teacher/edit/' . $assigned->id) }}"
                                                                method="post">
                                                                @csrf
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="modal fade" id="rejectModal{{ $assigned->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form action="{{ url('manager/reject_teacher') }}"
                                                                method="post">
                                                                @csrf
                                                                <input type="hidden" name="teacher_id"
                                                                    value="{{ $assigned->teacher->id }}" />
                                            ...
                                            <div class="modal fade" id="confirmedModal{{ $assigned->id }}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form action="{{ url('manager/confirm_teacher') }}"
                                                                method="post">
                                                                @csrf
                                                                <input type="hidden" name="teacher_id"
                                                                    value="{{ $assigned->teacher->id }}" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @if ($studentDetails->lead_generator)
                                                                        <hr>
                                                                        <lebel>Set Salary (Fixed Salary is required for Lead
                                                                            Job):</lebel>
                                                                        <input name="salary" class="form-control my-2"
                                                                            value="{{ $studentDetails->t_salary }}"
                                                                            required="required">
                                                                        <lebel>Set Lead Percentage (Default: 10):</lebel>
                                                                        <input name="lead_percentage"
                                                                ...
                                                                <h5 class="text-center">Tuition Fee:
                                                                    {{ $studentDetails->t_salary }} Tk</h5>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" min="0"
                                                                        ...
                                                                        name="fee" class="form-control my-2"
                                                                        required="required">
                                ...
                                @if ($assigned2->teacher)
                                    <div class="card mb-3">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-5 col-xs-12 text-center">
                                                <a
                                                    href="{{ url('/manager/teacher_details') }}{{ $assigned2->teacher->id }}">
                ...
                <div class="col-md-12">
                    <div class="card p-3 mb-2 text-center row">
                        <h5>Tuition match teacher profile: {{ isset($teacher) ? $teacher->count() : 0 }} <a
                                href="{{ url('/manager/receiver_list/' . $studentDetails->id) }}" type="button"
                    ...
                    @forelse($teacher as $profile)
                        <div class="card mb-3">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ url('/manager/teacher_details') }}{{ $profile->user_id }}"
                        ...
                        <div class="modal fade" id="exampleModal{{ $profile->user_id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="{{ url('manager/assign_teacher') }}" method="post">
                                            @csrf
                ...
                <div class="col-md-12">
                    <div class="card p-3 mb-2 text-center">
                        <h5>Applied teacher profile: {{ isset($applied_teacher) ? $applied_teacher->count() : 0 }} <a
                                href="{{ url('/manager/applied_receiver_list/' . $studentDetails->id) }}" type="button"
                        ...
                        @if ($data->profile)
                            <div class="card mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <a href="{{ url('/manager/teacher_details') }}{{ $data->profile->user_id }}"
                                            class="btn btn-lg btn-info mt-2">View Details</a>
...
@section('script')
    ...
    <script>
        $(document).on('click', '#btnSendData', function(event) {
            ...
            $.ajax({
                url: "{{ route('manager.find_teacher') }}",
                data: formData,
                processData: false,
                contentType: false,
                type: 'POST',
