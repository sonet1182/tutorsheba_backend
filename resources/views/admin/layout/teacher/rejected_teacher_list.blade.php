                            ...
                            <table class="table" id="dataTable">
                                ...
                                @foreach($teacherProfile as $teacher)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/teacher_details') }}{{ $teacher->id }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit font-20"></i></a>
