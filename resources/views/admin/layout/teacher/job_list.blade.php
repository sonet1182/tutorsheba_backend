                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                        ...
                                        <td style="width: 80px">
                                            <a href="{{ url('admin/student_details') }}{{ $studentinfo->student->id }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-edit font-14"></i></a>
