            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="col-md-4">
                            <!--<form action="{{ url('admin/approval_student_list/by_manager') }}" method="POST" class="row">-->
                            <!--@csrf-->
                            ...
                            <select class="form-control col-12" name="manager" onchange="location = this.value;">
                                ...
                                @foreach ($manager_list as $managert)
                                    <option value="{{ url('admin/approval_student_list/by_manager/' . $managert->id) }}"
                                        {{ $manager == $managert->id ? 'selected' : '' }}>{{ $managert->name }}</option>
                                @endforeach
                            </select>
                            ...
                            <!--<button class="btn btn-primary col-4" type="submit">By Manager</button>-->
                            <!--</form>-->
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach ($studentProfile as $student)
                                        <tr>
                                            ...
                                            <td>{{ $student->s_fullName }}
                                                @if ($student->partner)
                                                    <br>
                                                    <a href="{{ url('admin/uddokta_details/' . $student->partner->id) }}">
                                                        <span
