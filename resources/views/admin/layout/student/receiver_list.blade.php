                                        ...
                                        <tr>
                                            <td>
                                                <input class="text-center" type="checkbox" name="all_option[]"
                                                    value="{{ $value->user ? $value->user->phoneNumber : '' }}">
                                            </td>
                                            <td>{{ $value->user_id }}</td>
                                            <td>
                                                <img class="styleBorderImg"
                                                    src="{{ asset($value->teacher_profile_picture) }}" alt=""
                                            ...
                                            <td>
                                                <a href="{{ url('/admin/teacher_details' . $value->user_id) }}" title="View"
                                                    class="btn btn-info btn-xs px-2"><i class="fa fa-eye"
