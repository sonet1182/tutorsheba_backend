                ...
                <div class="card">
                    <div class="card-body row">
                        <div class="col-md-6 ">
                                ...
                                <form action="{{ url('admin/tuition_search_by_id') }}" class="row">
                                    @csrf
                        ...
                        <div class="col-md-6">
                            <form action="{{ url('admin/tuition_search_phone') }}" class="row">
                                    @csrf
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($studentProfile as $student)
                                    <tr>
                                        ...
                                        <td style="width: 80px">
                                            <a href="{{ url('admin/student_details') }}{{ $student->id }}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Details"><i class="fa fa-info-circle font-14"></i></a>
