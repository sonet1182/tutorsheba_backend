                    ...
                    <div class="ibox-body table-responsive">
                        <table class="table table-bordered" id="dataTable2">
                            ...
                            @foreach($teacher as $value)
                                <tr>
                                    <td>
                                         <input class="text-center" type="checkbox" name="all_option[]" value="{{ $value->profile ? $value->profile->phoneNumber : '' }}">
                                    </td>
                                    <td>{{ $value->profile->teacher_id }}</td>
                                    <td>
                                        <img class="styleBorderImg" src="{{ asset($value->profile->teacher_profile_picture) }}" alt="" height="60px" width="60px"
                            onerror="this.onerror=null;this.src='https://cdn4.iconfinder.com/data/icons/instagram-ui-twotone/48/Paul-18-512.png';"/>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/teacher_details'.$value->teacher->id) }}" title="View" class="btn btn-info btn-xs px-2"><i class="fa fa-eye" aria-hidden="true"></i></a>
