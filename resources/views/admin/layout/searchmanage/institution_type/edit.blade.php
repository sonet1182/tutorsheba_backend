        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-header">Edit Institute Type #{{ $institution_type->id }}</div>
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/institution_type/update/' . $institution_type->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name:</label>
                                <input type="text" name="name" class="form-control" value="{{ $institution_type->name }}"
