        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-header">Edit Study Type #{{ $study_type->id }}</div>
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/study_type/update/' . $study_type->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">Name:</label>
                                <input type="text" name="name" class="form-control" value="{{ $study_type->name }}"
