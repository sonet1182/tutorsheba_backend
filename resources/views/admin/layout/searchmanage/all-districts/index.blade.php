                            ...
                            <table class="table" id="dataTable">
                                ...
                                @foreach($alldistricts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/all-districts/' . $item->id . '/edit') }}" title="Edit District"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            <a href="{{ url('/admin/all-districts/' . $item->id . '/delete') }}" title="Delete District"><button class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Delete</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
