        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-header">Create New salaryRange</div>
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ url('/admin/salary-range/store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">Slary Range</label>
                                <input type="number" class="form-control" name="name" placeholder="00" style="max-width: 200px">
