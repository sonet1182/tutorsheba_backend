...
@section('content')
    <div class="page-heading">
        <h1 class="page-title">Deleted Manager List</h1>
        <ol class="breadcrumb">
    ...
    <div class="page-content fade-in-up">
        <div class="card">
            <div class="card-header">
                <h3 class="text-center">Deleted Manager List</h3>
                <!--<div class="row">-->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($deleted_managers as $tutors)
                                <tr>
                                    <td>
                                        {{ $tutors->id }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <!--    class="btn btn-default btn-xs m-r-5"><i class="fa fa-pencil font-14"></i></button>-->

                                        <button type="button"
                                            data-href="{{ url('/admin/enable_manager/'.$tutors->id) }}"
                                            class="btn btn-xs btn-success delete_barcode_button"><i
                                    ...
                                    <!--                            value="{{ $tutors->name }}" />-->
                                    <!--                    </div>-->
                                    <!--                    <button class="btn btn-lg btn-outline-primary px-4">Submit</button>-->
                                    <!--                </form>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
...
@section('script')
    <script type="text/javascript">
        $(document).on('click', 'button.delete_barcode_button', function() {
            if (confirm("Are you sure you want to enable this Manager?")) {
