...
@section('content')
    <div class="page-heading">
        <h1 class="page-title">Tutor ID: {{ $tutor->teacher_id }} Premium Membership Creator</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/admin') }}"><i class="icon-home2 position-left"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="{{ url('admin/membership') }}">Membeship List</a></li>
            <li class="breadcrumb-item">Membeship Create</li>
        </ol>
    </div>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['url' => '/admin/membership/store','method'=>'POST', 'class'=>'well form-horizontal']) !!}
                        <div class="form-group {{ $errors->has('plan_id') ? ' has-error' : '' }}">
                            ...
                            <div class="controls col-sm-12 col-xs-12">
                                <select class="form-control" name="plan_id">
                                    <?php $plan_id = !empty($tutor->member->plan_id) ? $tutor->member->plan_id : 0; ?>
                                    <option value="1" {{ $plan_id == 1 ? "selected" : ''}}>Plan 1 30 days</option>
                                    <option value="2" {{ $plan_id == 2 ? "selected" : ''}}>Plan 2 90 days</option>
                                    <option value="3" {{ $plan_id == 3 ? "selected" : ''}}>Plan 3 180 days</option>
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="controls col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="amount" value="{{ !empty($tutor->member->amount) ? $tutor->member->amount : '0' }}" placeholder="amount">
