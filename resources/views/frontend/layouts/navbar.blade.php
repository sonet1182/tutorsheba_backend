<nav class="vertical_nav">
    <div class="left_section menu_left" id="js-menu">
        <div class="left_section">
            <ul>
                <li class="menu--item">
                    <a href="{{ url('/') }}" class="menu--link {{ Request::path() == '/' ? 'active' : '' }}" title="Home">
                        <i class='uil uil-home-alt menu--icon'></i>
                        <span class="menu--label">Home</span>
                    </a>
                </li>
                <li class="menu--item">
                    <a href="{{ url('/featured-tutors') }}" class="menu--link {{ Request::path() == 'featured-tutors' ? 'active' : '' }}" title="Live Streams">
                        <i class='uil uil-user menu--icon'></i>
                        <span class="menu--user">Featured Tutors</span>
                    </a>
                </li>
                <li class="menu--item">
                    <a href="{{ route('tutor_request') }}" class="menu--link {{ Request::path() == 'request-for-tutor' ? 'active' : '' }}" title="Live Streams">
                        <i class='uil uil-user menu--icon'></i>
                        <span class="menu--label">Tutor Request</span>
                    </a>
                </li>
                <li class="menu--item">
                    <a href="{{ route('tuition-list') }}" class="menu--link {{ Request::path() == 'tuition-list' ? 'active' : '' }}" title="Live Streams">
                        <i class='uil uil-user menu--icon'></i>
                        <span class="menu--label">Tution Jobs</span>
                    </a>
                </li>
                <li class="menu--item">
                    <a href="https://course.tutorsheba.com/" class="menu--link" title="Explore">
        ...
        <div class="left_section">
            <div class="strttech120 bg-purple-400">
                <small>Become Our</sma>
                ...
                <button class="Get_btn" onclick="window.location.href = '#';">Click Here</button>
            </div>
        </div>
