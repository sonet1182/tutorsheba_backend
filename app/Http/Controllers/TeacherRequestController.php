...
class TeacherRequestController extends Controller
{
    ...
    public function newTeacherRequest()
    {
        ...
        return view('admin.layout.teacher.new_teacher_request', compact('teacherProfile', 'total'));
    }

    public function newTeacherRequest_approve_all()
    {
        $teacherProfile = User::where('approval', 0)->update(['approval' => 1]);
    ...
    public function approvalTeacherList()
    {
        ...
        return view('admin.layout.teacher.approval_teacher_list', compact('teacherProfile', 'total'));
    }
    ...
    public function verifiedTeacherList()
    {
        ...
        return view('admin.layout.teacher.verified_teacher_list', compact('teacherProfile', 'total'));
    }
    ...
    public function rejectedTeacherList()
    {
        $teacherProfile = DB::table('teacher_profile')
            ...
            ->orderBy('id', 'DESC')
            ->get();
        return view('admin.layout.teacher.rejected_teacher_list', compact('teacherProfile'));
    }
    ...
    public function teacherDetails($id)
    {
        ...
        if ($teacherDetails) {
            ...
            $review_data = Review::where('tutor_id', $id)->with('student')->get();

            return view('admin.layout.teacher.teacher_details', compact('teacherDetails', 'applied', 'assigned', 'confirmed', 'cancelled', 'review_data'));
        } else {
    ...
    public function homeApprovalTeacherList()
    {
            ...
            ->latest()
            ->paginate(21);
        return view('admin.layout.teacher.home-approval', compact('teacherProfile'));
    }
