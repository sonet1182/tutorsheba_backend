...
class AllRequestController extends Controller
{
    ...
    public function studentTutorRequest()
    {
        $tutorRequest = DB::table('student_tutors_request')
            ...
            ->paginate(10);
        return view('admin.layout.request.student_tutor_request',compact('tutorRequest'));
    }
      public function teacherTuitionRequest()
    {
        $tuitionRequest = TuitionRequest::with('teacher','student')
            ...
            ->paginate(10);
        return view('admin.layout.request.teacher_tuition_request',compact('tuitionRequest'));
    }
    ...
    public function requestDetails($id)
    {
        ...
        return view('admin.layout.request.request-details',compact('teacherDetails','studentDetails','tuitionRequest'));
    }
    ...
    public function profile_verification_request()
    {
        ...
        return view('admin.layout.request.profile_verification_request',compact('tutorRequest'));
    }
}
